...
namespace N.FourWar.Web.Controllers {
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_HomeController: N.FourWar.Web.Controllers.HomeController {
        ...
        public override System.Web.Mvc.ActionResult User(N.FourWar.Web.Models.UserModel userModel) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.User);
